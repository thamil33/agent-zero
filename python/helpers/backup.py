...
class BackupService:
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes ScrAI project directory patterns.
        """
...
{agent_root}/tmp/uploads/**"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up ScrAI root path with the current ScrAI root path
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up ScrAI root
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up ScrAI root
