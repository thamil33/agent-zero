...
class AgentZeroWorker(Worker):  # type: ignore[misc]
    """ScrAI implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through ScrAI."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to ScrAI format
            ...
            # Process message through ScrAI (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to ScrAI UserMessage."""
